...
@section('content')
    <div class="card">
        <div class="card-header">Add new Patterns</div>
        <div class="card-body">
            <form action="{{ route('admin.pattern.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('rooms') is-invalid @enderror" name="rooms" value="{{ old('rooms') }}">
